...
export default function Home() {
  ...
  return (
    <S.Wrapper>
      ...
      <S.Description>
        With this app, you can <strong>easily</strong> manage your tasks by creating specific boards
        to specific contexts, separating them into columns and task cards.
      </S.Description>

      <S.SelectBoardWrapper>
        <span className='select-a-board-text'>Select a board to start managing your tasks 😉</span>
